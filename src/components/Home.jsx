...
const Home = () => {
    ...
    return (
        <FinanceDashboardLayout>
            <div className="relative min-h-screen bg-[#0a0a0a] text-white overflow-hidden selection:bg-[#97b85d] selection:text-black">

                {/* Global Backgrounds (Visible after Shutter opens) */}
                <CurrencyBackground />
                <CoinBackground />
                {/* Subtle Grid Overlay */}
